...
func AuthWhatsApp(Pesan model.WAMessage, db *mongo.Database) (reply string) {
	...
	statuscode, httpresp, err := jsonapi.PostStructWithToken[model.Response]("secret", conf.DomyikadoSecret, recentUserAuth, conf.DomyikadoUserURL)
	if err != nil {
