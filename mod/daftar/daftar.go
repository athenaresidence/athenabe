...
func DaftarDomyikado(Profile model.Profile, Pesan model.WAMessage, db *mongo.Database) (reply string) {
	...
	statuscode, httpresp, err := jsonapi.PostStructWithToken[model.Response]("secret", conf.DomyikadoSecret, calonuser, conf.DomyikadoUserURL)
	if err != nil {
