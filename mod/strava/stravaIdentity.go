...
func StravaIdentityHandler(Profile model.Profile, Pesan model.WAMessage, db *mongo.Database) string {
...
func scrapeStravaIdentity(db *mongo.Database, url, profilePhone, phone, alias string) string {
	...
	c.OnScraped(func(r *colly.Response) {
		...
		data, err := mgdb.GetOneDoc[StravaIdentity](db, col, bson.M{"athlete_id": stravaIdentity.AthleteId})
		...
		_, err = mgdb.InsertOneDoc(db, col, stravaIdentity)
		if err != nil {
